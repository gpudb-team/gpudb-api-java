...
public class filter_by_nai_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"filter_by_nai_response\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"count\",\"type\":\"long\"}]}");
   ...
   */
  public filter_by_nai_response(java.lang.Long count) {
    this.count = count;
  }
  ...
  public static avro.java.gpudb.filter_by_nai_response.Builder newBuilder() {
    return new avro.java.gpudb.filter_by_nai_response.Builder();
  }
  
  /** Creates a new filter_by_nai_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.filter_by_nai_response.Builder newBuilder(avro.java.gpudb.filter_by_nai_response.Builder other) {
    return new avro.java.gpudb.filter_by_nai_response.Builder(other);
  }
  
  /** Creates a new filter_by_nai_response RecordBuilder by copying an existing filter_by_nai_response instance */
  public static avro.java.gpudb.filter_by_nai_response.Builder newBuilder(avro.java.gpudb.filter_by_nai_response other) {
    return new avro.java.gpudb.filter_by_nai_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<filter_by_nai_response>
    ...
    private Builder() {
      super(avro.java.gpudb.filter_by_nai_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.filter_by_nai_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing filter_by_nai_response instance */
    private Builder(avro.java.gpudb.filter_by_nai_response other) {
            super(avro.java.gpudb.filter_by_nai_response.SCHEMA$);
    ...
    /** Sets the value of the 'count' field */
    public avro.java.gpudb.filter_by_nai_response.Builder setCount(long value) {
    ...
    public avro.java.gpudb.filter_by_nai_response.Builder clearCount() {
