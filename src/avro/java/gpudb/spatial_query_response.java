...
public class spatial_query_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"spatial_query_response\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"result\",\"type\":\"boolean\"}]}");
  ...
  public static avro.java.gpudb.spatial_query_response.Builder newBuilder() {
    return new avro.java.gpudb.spatial_query_response.Builder();
  }
  
  /** Creates a new spatial_query_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.spatial_query_response.Builder newBuilder(avro.java.gpudb.spatial_query_response.Builder other) {
    return new avro.java.gpudb.spatial_query_response.Builder(other);
  }
  
  /** Creates a new spatial_query_response RecordBuilder by copying an existing spatial_query_response instance */
  public static avro.java.gpudb.spatial_query_response.Builder newBuilder(avro.java.gpudb.spatial_query_response other) {
    return new avro.java.gpudb.spatial_query_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<spatial_query_response>
    ...
    private Builder() {
      super(avro.java.gpudb.spatial_query_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.spatial_query_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing spatial_query_response instance */
    private Builder(avro.java.gpudb.spatial_query_response other) {
            super(avro.java.gpudb.spatial_query_response.SCHEMA$);
    ...
    /** Sets the value of the 'result' field */
    public avro.java.gpudb.spatial_query_response.Builder setResult(boolean value) {
    ...
    public avro.java.gpudb.spatial_query_response.Builder clearResult() {
