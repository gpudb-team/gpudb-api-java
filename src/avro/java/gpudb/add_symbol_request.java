...
public class add_symbol_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"add_symbol_request\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"symbol_id\",\"type\":\"string\"},{\"name\":\"symbol_format\",\"type\":\"string\"},{\"name\":\"symbol_data\",\"type\":\"bytes\"},{\"name\":\"params\",\"type\":{\"type\":\"map\",\"values\":\"string\"}}]}");
  ...
  public static avro.java.gpudb.add_symbol_request.Builder newBuilder() {
    return new avro.java.gpudb.add_symbol_request.Builder();
  }
  
  /** Creates a new add_symbol_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.add_symbol_request.Builder newBuilder(avro.java.gpudb.add_symbol_request.Builder other) {
    return new avro.java.gpudb.add_symbol_request.Builder(other);
  }
  
  /** Creates a new add_symbol_request RecordBuilder by copying an existing add_symbol_request instance */
  public static avro.java.gpudb.add_symbol_request.Builder newBuilder(avro.java.gpudb.add_symbol_request other) {
    return new avro.java.gpudb.add_symbol_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<add_symbol_request>
    ...
    private Builder() {
      super(avro.java.gpudb.add_symbol_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.add_symbol_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing add_symbol_request instance */
    private Builder(avro.java.gpudb.add_symbol_request other) {
            super(avro.java.gpudb.add_symbol_request.SCHEMA$);
    ...
    /** Sets the value of the 'symbol_id' field */
    public avro.java.gpudb.add_symbol_request.Builder setSymbolId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.add_symbol_request.Builder clearSymbolId() {
      symbol_id = null;
    ...
    /** Sets the value of the 'symbol_format' field */
    public avro.java.gpudb.add_symbol_request.Builder setSymbolFormat(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.add_symbol_request.Builder clearSymbolFormat() {
      symbol_format = null;
    ...
    /** Sets the value of the 'symbol_data' field */
    public avro.java.gpudb.add_symbol_request.Builder setSymbolData(java.nio.ByteBuffer value) {
    ...
    public avro.java.gpudb.add_symbol_request.Builder clearSymbolData() {
      symbol_data = null;
    ...
    /** Sets the value of the 'params' field */
    public avro.java.gpudb.add_symbol_request.Builder setParams(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.add_symbol_request.Builder clearParams() {
      params = null;
