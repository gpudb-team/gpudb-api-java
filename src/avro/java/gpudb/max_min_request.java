...
public class max_min_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"max_min_request\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"attribute\",\"type\":\"string\"},{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"user_auth_string\",\"type\":\"string\"}]}");
   ...
   * Default constructor.
   */
  public max_min_request() {}

  /**
   * All-args constructor.
   */
  public max_min_request(java.lang.CharSequence attribute, java.lang.CharSequence set_id, java.lang.CharSequence user_auth_string) {
  ...
  /** Creates a new max_min_request RecordBuilder */
  public static avro.java.gpudb.max_min_request.Builder newBuilder() {
    return new avro.java.gpudb.max_min_request.Builder();
  }
  
  /** Creates a new max_min_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.max_min_request.Builder newBuilder(avro.java.gpudb.max_min_request.Builder other) {
    return new avro.java.gpudb.max_min_request.Builder(other);
  }
  
  /** Creates a new max_min_request RecordBuilder by copying an existing max_min_request instance */
  public static avro.java.gpudb.max_min_request.Builder newBuilder(avro.java.gpudb.max_min_request other) {
    return new avro.java.gpudb.max_min_request.Builder(other);
  }
  
  /**
   * RecordBuilder for max_min_request instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<max_min_request>
    implements org.apache.avro.data.RecordBuilder<max_min_request> {
    ...
    private Builder() {
      super(avro.java.gpudb.max_min_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.max_min_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing max_min_request instance */
    private Builder(avro.java.gpudb.max_min_request other) {
            super(avro.java.gpudb.max_min_request.SCHEMA$);
    ...
    /** Sets the value of the 'attribute' field */
    public avro.java.gpudb.max_min_request.Builder setAttribute(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.max_min_request.Builder clearAttribute() {
      attribute = null;
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.max_min_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.max_min_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gpudb.max_min_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.max_min_request.Builder clearUserAuthString() {
    ...
    @Override
    public max_min_request build() {
      try {
        max_min_request record = new max_min_request();
