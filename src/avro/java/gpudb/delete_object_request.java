...
public class delete_object_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"delete_object_request\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"set_ids\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"OBJECT_ID\",\"type\":\"string\"},{\"name\":\"user_auth_string\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gpudb.delete_object_request.Builder newBuilder() {
    return new avro.java.gpudb.delete_object_request.Builder();
  }
  
  /** Creates a new delete_object_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.delete_object_request.Builder newBuilder(avro.java.gpudb.delete_object_request.Builder other) {
    return new avro.java.gpudb.delete_object_request.Builder(other);
  }
  
  /** Creates a new delete_object_request RecordBuilder by copying an existing delete_object_request instance */
  public static avro.java.gpudb.delete_object_request.Builder newBuilder(avro.java.gpudb.delete_object_request other) {
    return new avro.java.gpudb.delete_object_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<delete_object_request>
    ...
    private Builder() {
      super(avro.java.gpudb.delete_object_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.delete_object_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing delete_object_request instance */
    private Builder(avro.java.gpudb.delete_object_request other) {
            super(avro.java.gpudb.delete_object_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_ids' field */
    public avro.java.gpudb.delete_object_request.Builder setSetIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.delete_object_request.Builder clearSetIds() {
      set_ids = null;
    ...
    /** Sets the value of the 'OBJECT_ID' field */
    public avro.java.gpudb.delete_object_request.Builder setOBJECTID(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.delete_object_request.Builder clearOBJECTID() {
      OBJECT_ID = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gpudb.delete_object_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.delete_object_request.Builder clearUserAuthString() {
