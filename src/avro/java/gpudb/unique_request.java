...
public class unique_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gpudb.unique_request.Builder newBuilder() {
    return new avro.java.gpudb.unique_request.Builder();
  }
  
  /** Creates a new unique_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.unique_request.Builder newBuilder(avro.java.gpudb.unique_request.Builder other) {
    return new avro.java.gpudb.unique_request.Builder(other);
  }
  
  /** Creates a new unique_request RecordBuilder by copying an existing unique_request instance */
  public static avro.java.gpudb.unique_request.Builder newBuilder(avro.java.gpudb.unique_request other) {
    return new avro.java.gpudb.unique_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<unique_request>
    ...
    private Builder() {
      super(avro.java.gpudb.unique_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.unique_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing unique_request instance */
    private Builder(avro.java.gpudb.unique_request other) {
            super(avro.java.gpudb.unique_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.unique_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.unique_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'attribute' field */
    public avro.java.gpudb.unique_request.Builder setAttribute(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.unique_request.Builder clearAttribute() {
      attribute = null;
