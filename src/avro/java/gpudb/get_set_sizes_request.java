...
public class get_set_sizes_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"get_set_sizes_request\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"set_ids\",\"type\":{\"type\":\"array\",\"items\":\"string\"}}]}");
  ...
  public static avro.java.gpudb.get_set_sizes_request.Builder newBuilder() {
    return new avro.java.gpudb.get_set_sizes_request.Builder();
  }
  
  /** Creates a new get_set_sizes_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.get_set_sizes_request.Builder newBuilder(avro.java.gpudb.get_set_sizes_request.Builder other) {
    return new avro.java.gpudb.get_set_sizes_request.Builder(other);
  }
  
  /** Creates a new get_set_sizes_request RecordBuilder by copying an existing get_set_sizes_request instance */
  public static avro.java.gpudb.get_set_sizes_request.Builder newBuilder(avro.java.gpudb.get_set_sizes_request other) {
    return new avro.java.gpudb.get_set_sizes_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<get_set_sizes_request>
    ...
    private Builder() {
      super(avro.java.gpudb.get_set_sizes_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.get_set_sizes_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing get_set_sizes_request instance */
    private Builder(avro.java.gpudb.get_set_sizes_request other) {
            super(avro.java.gpudb.get_set_sizes_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_ids' field */
    public avro.java.gpudb.get_set_sizes_request.Builder setSetIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.get_set_sizes_request.Builder clearSetIds() {
      set_ids = null;
