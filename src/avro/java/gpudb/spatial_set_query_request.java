...
public class spatial_set_query_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gpudb.spatial_set_query_request.Builder newBuilder() {
    return new avro.java.gpudb.spatial_set_query_request.Builder();
  }
  
  /** Creates a new spatial_set_query_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.spatial_set_query_request.Builder newBuilder(avro.java.gpudb.spatial_set_query_request.Builder other) {
    return new avro.java.gpudb.spatial_set_query_request.Builder(other);
  }
  
  /** Creates a new spatial_set_query_request RecordBuilder by copying an existing spatial_set_query_request instance */
  public static avro.java.gpudb.spatial_set_query_request.Builder newBuilder(avro.java.gpudb.spatial_set_query_request other) {
    return new avro.java.gpudb.spatial_set_query_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<spatial_set_query_request>
    ...
    private Builder() {
      super(avro.java.gpudb.spatial_set_query_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.spatial_set_query_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing spatial_set_query_request instance */
    private Builder(avro.java.gpudb.spatial_set_query_request other) {
            super(avro.java.gpudb.spatial_set_query_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_ids' field */
    public avro.java.gpudb.spatial_set_query_request.Builder setSetIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.spatial_set_query_request.Builder clearSetIds() {
      set_ids = null;
    ...
    /** Sets the value of the 'wkt_attr_name' field */
    public avro.java.gpudb.spatial_set_query_request.Builder setWktAttrName(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.spatial_set_query_request.Builder clearWktAttrName() {
      wkt_attr_name = null;
    ...
    /** Sets the value of the 'wkt_string' field */
    public avro.java.gpudb.spatial_set_query_request.Builder setWktString(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.spatial_set_query_request.Builder clearWktString() {
      wkt_string = null;
    ...
    /** Sets the value of the 'operation' field */
    public avro.java.gpudb.spatial_set_query_request.Builder setOperation(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.spatial_set_query_request.Builder clearOperation() {
      operation = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gpudb.spatial_set_query_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.spatial_set_query_request.Builder clearUserAuthString() {
