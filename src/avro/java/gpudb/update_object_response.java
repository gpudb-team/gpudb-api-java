...
public class update_object_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"update_object_response\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"status\",\"type\":\"string\"},{\"name\":\"OBJECT_ID\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gpudb.update_object_response.Builder newBuilder() {
    return new avro.java.gpudb.update_object_response.Builder();
  }
  
  /** Creates a new update_object_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.update_object_response.Builder newBuilder(avro.java.gpudb.update_object_response.Builder other) {
    return new avro.java.gpudb.update_object_response.Builder(other);
  }
  
  /** Creates a new update_object_response RecordBuilder by copying an existing update_object_response instance */
  public static avro.java.gpudb.update_object_response.Builder newBuilder(avro.java.gpudb.update_object_response other) {
    return new avro.java.gpudb.update_object_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<update_object_response>
    ...
    private Builder() {
      super(avro.java.gpudb.update_object_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.update_object_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing update_object_response instance */
    private Builder(avro.java.gpudb.update_object_response other) {
            super(avro.java.gpudb.update_object_response.SCHEMA$);
    ...
    /** Sets the value of the 'status' field */
    public avro.java.gpudb.update_object_response.Builder setStatus(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.update_object_response.Builder clearStatus() {
      status = null;
    ...
    /** Sets the value of the 'OBJECT_ID' field */
    public avro.java.gpudb.update_object_response.Builder setOBJECTID(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.update_object_response.Builder clearOBJECTID() {
      OBJECT_ID = null;
