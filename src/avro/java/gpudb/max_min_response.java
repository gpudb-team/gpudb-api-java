...
public class max_min_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"max_min_response\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"max\",\"type\":\"double\"},{\"name\":\"min\",\"type\":\"double\"}]}");
  ...
  public static avro.java.gpudb.max_min_response.Builder newBuilder() {
    return new avro.java.gpudb.max_min_response.Builder();
  }
  
  /** Creates a new max_min_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.max_min_response.Builder newBuilder(avro.java.gpudb.max_min_response.Builder other) {
    return new avro.java.gpudb.max_min_response.Builder(other);
  }
  
  /** Creates a new max_min_response RecordBuilder by copying an existing max_min_response instance */
  public static avro.java.gpudb.max_min_response.Builder newBuilder(avro.java.gpudb.max_min_response other) {
    return new avro.java.gpudb.max_min_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<max_min_response>
    ...
    private Builder() {
      super(avro.java.gpudb.max_min_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.max_min_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing max_min_response instance */
    private Builder(avro.java.gpudb.max_min_response other) {
            super(avro.java.gpudb.max_min_response.SCHEMA$);
    ...
    /** Sets the value of the 'max' field */
    public avro.java.gpudb.max_min_response.Builder setMax(double value) {
    ...
    public avro.java.gpudb.max_min_response.Builder clearMax() {
    ...
    /** Sets the value of the 'min' field */
    public avro.java.gpudb.max_min_response.Builder setMin(double value) {
    ...
    public avro.java.gpudb.max_min_response.Builder clearMin() {
