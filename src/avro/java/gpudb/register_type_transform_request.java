...
public class register_type_transform_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"register_type_transform_request\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"type_id\",\"type\":\"string\"},{\"name\":\"new_type_id\",\"type\":\"string\"},{\"name\":\"transform_map\",\"type\":{\"type\":\"map\",\"values\":\"string\"}}]}");
  ...
  public static avro.java.gpudb.register_type_transform_request.Builder newBuilder() {
    return new avro.java.gpudb.register_type_transform_request.Builder();
  }
  
  /** Creates a new register_type_transform_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.register_type_transform_request.Builder newBuilder(avro.java.gpudb.register_type_transform_request.Builder other) {
    return new avro.java.gpudb.register_type_transform_request.Builder(other);
  }
  ...
  public static avro.java.gpudb.register_type_transform_request.Builder newBuilder(avro.java.gpudb.register_type_transform_request other) {
    return new avro.java.gpudb.register_type_transform_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<register_type_transform_request>
    ...
    private Builder() {
      super(avro.java.gpudb.register_type_transform_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.register_type_transform_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing register_type_transform_request instance */
    private Builder(avro.java.gpudb.register_type_transform_request other) {
            super(avro.java.gpudb.register_type_transform_request.SCHEMA$);
    ...
    /** Sets the value of the 'type_id' field */
    public avro.java.gpudb.register_type_transform_request.Builder setTypeId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.register_type_transform_request.Builder clearTypeId() {
      type_id = null;
    ...
    /** Sets the value of the 'new_type_id' field */
    public avro.java.gpudb.register_type_transform_request.Builder setNewTypeId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.register_type_transform_request.Builder clearNewTypeId() {
      new_type_id = null;
    ...
    /** Sets the value of the 'transform_map' field */
    public avro.java.gpudb.register_type_transform_request.Builder setTransformMap(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.register_type_transform_request.Builder clearTransformMap() {
      transform_map = null;
