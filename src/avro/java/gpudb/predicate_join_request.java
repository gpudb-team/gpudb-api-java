...
public class predicate_join_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gpudb.predicate_join_request.Builder newBuilder() {
    return new avro.java.gpudb.predicate_join_request.Builder();
  }
  
  /** Creates a new predicate_join_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.predicate_join_request.Builder newBuilder(avro.java.gpudb.predicate_join_request.Builder other) {
    return new avro.java.gpudb.predicate_join_request.Builder(other);
  }
  
  /** Creates a new predicate_join_request RecordBuilder by copying an existing predicate_join_request instance */
  public static avro.java.gpudb.predicate_join_request.Builder newBuilder(avro.java.gpudb.predicate_join_request other) {
    return new avro.java.gpudb.predicate_join_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<predicate_join_request>
    ...
    private Builder() {
      super(avro.java.gpudb.predicate_join_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.predicate_join_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing predicate_join_request instance */
    private Builder(avro.java.gpudb.predicate_join_request other) {
            super(avro.java.gpudb.predicate_join_request.SCHEMA$);
    ...
    /** Sets the value of the 'left_set' field */
    public avro.java.gpudb.predicate_join_request.Builder setLeftSet(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.predicate_join_request.Builder clearLeftSet() {
      left_set = null;
    ...
    /** Sets the value of the 'right_set' field */
    public avro.java.gpudb.predicate_join_request.Builder setRightSet(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.predicate_join_request.Builder clearRightSet() {
      right_set = null;
    ...
    /** Sets the value of the 'common_type' field */
    public avro.java.gpudb.predicate_join_request.Builder setCommonType(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.predicate_join_request.Builder clearCommonType() {
      common_type = null;
    ...
    /** Sets the value of the 'result_type' field */
    public avro.java.gpudb.predicate_join_request.Builder setResultType(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.predicate_join_request.Builder clearResultType() {
      result_type = null;
    ...
    /** Sets the value of the 'result_set' field */
    public avro.java.gpudb.predicate_join_request.Builder setResultSet(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.predicate_join_request.Builder clearResultSet() {
      result_set = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gpudb.predicate_join_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.predicate_join_request.Builder clearUserAuthString() {
    ...
    /** Sets the value of the 'predicate' field */
    public avro.java.gpudb.predicate_join_request.Builder setPredicate(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.predicate_join_request.Builder clearPredicate() {
      predicate = null;
