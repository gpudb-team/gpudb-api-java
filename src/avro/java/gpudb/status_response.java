...
public class status_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<java.lang.Long> sizes;
  @Deprecated public java.util.List<java.lang.Long> full_sizes;
  @Deprecated public java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> child_map;
  @Deprecated public long total_size;
  @Deprecated public long total_full_size;
   ...
   */
  public status_response(java.lang.CharSequence set_id, java.util.List<java.lang.CharSequence> set_ids, java.util.List<java.lang.Boolean> is_parent, java.util.List<java.lang.CharSequence> semantic_types, java.util.List<java.lang.CharSequence> labels, java.util.List<java.lang.Long> sizes, java.util.List<java.lang.Long> full_sizes, java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> child_map, java.lang.Long total_size, java.lang.Long total_full_size) {
    this.set_id = set_id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: sizes = (java.util.List<java.lang.Long>)value$; break;
    case 6: full_sizes = (java.util.List<java.lang.Long>)value$; break;
    case 7: child_map = (java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>)value$; break;
    case 8: total_size = (java.lang.Long)value$; break;
    case 9: total_full_size = (java.lang.Long)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<java.lang.Long> getSizes() {
    return sizes;
  }
   ...
   * @param value the value to set.
   */
  public void setSizes(java.util.List<java.lang.Long> value) {
    this.sizes = value;
  }
   ...
   */
  public java.util.List<java.lang.Long> getFullSizes() {
    return full_sizes;
  }
   ...
   * @param value the value to set.
   */
  public void setFullSizes(java.util.List<java.lang.Long> value) {
   ...
   */
  public java.lang.Long getTotalFullSize() {
   ...
   * @param value the value to set.
   */
  public void setTotalFullSize(java.lang.Long value) {
    this.total_full_size = value;
  }

  /** Creates a new status_response RecordBuilder */
  public static avro.java.gpudb.status_response.Builder newBuilder() {
    return new avro.java.gpudb.status_response.Builder();
  }
  
  /** Creates a new status_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.status_response.Builder newBuilder(avro.java.gpudb.status_response.Builder other) {
    return new avro.java.gpudb.status_response.Builder(other);
  }
  
  /** Creates a new status_response RecordBuilder by copying an existing status_response instance */
  public static avro.java.gpudb.status_response.Builder newBuilder(avro.java.gpudb.status_response other) {
    return new avro.java.gpudb.status_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<status_response>
    ...
    private java.util.List<java.lang.Long> sizes;
    private java.util.List<java.lang.Long> full_sizes;
    private java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> child_map;
    private long total_size;
    private long total_full_size;

    /** Creates a new Builder */
    private Builder() {
      super(avro.java.gpudb.status_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.status_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing status_response instance */
    private Builder(avro.java.gpudb.status_response other) {
            super(avro.java.gpudb.status_response.SCHEMA$);
      ...
      if (isValidValue(fields()[5], other.sizes)) {
        this.sizes = (java.util.List<java.lang.Long>) data().deepCopy(fields()[5].schema(), other.sizes);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], other.full_sizes)) {
        this.full_sizes = (java.util.List<java.lang.Long>) data().deepCopy(fields()[6].schema(), other.full_sizes);
      ...
      if (isValidValue(fields()[8], other.total_size)) {
        this.total_size = (java.lang.Long) data().deepCopy(fields()[8].schema(), other.total_size);
        fieldSetFlags()[8] = true;
      }
      if (isValidValue(fields()[9], other.total_full_size)) {
        this.total_full_size = (java.lang.Long) data().deepCopy(fields()[9].schema(), other.total_full_size);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.status_response.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.status_response.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'set_ids' field */
    public avro.java.gpudb.status_response.Builder setSetIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.status_response.Builder clearSetIds() {
      set_ids = null;
    ...
    /** Sets the value of the 'is_parent' field */
    public avro.java.gpudb.status_response.Builder setIsParent(java.util.List<java.lang.Boolean> value) {
    ...
    public avro.java.gpudb.status_response.Builder clearIsParent() {
      is_parent = null;
    ...
    /** Sets the value of the 'semantic_types' field */
    public avro.java.gpudb.status_response.Builder setSemanticTypes(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.status_response.Builder clearSemanticTypes() {
      semantic_types = null;
    ...
    /** Sets the value of the 'labels' field */
    public avro.java.gpudb.status_response.Builder setLabels(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.status_response.Builder clearLabels() {
      labels = null;
    ...
    /** Sets the value of the 'sizes' field */
    public avro.java.gpudb.status_response.Builder setSizes(java.util.List<java.lang.Long> value) {
    ...
    public avro.java.gpudb.status_response.Builder clearSizes() {
      sizes = null;
    ...
    /** Sets the value of the 'full_sizes' field */
    public avro.java.gpudb.status_response.Builder setFullSizes(java.util.List<java.lang.Long> value) {
    ...
    public avro.java.gpudb.status_response.Builder clearFullSizes() {
      full_sizes = null;
    ...
    /** Sets the value of the 'child_map' field */
    public avro.java.gpudb.status_response.Builder setChildMap(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public avro.java.gpudb.status_response.Builder clearChildMap() {
      child_map = null;
    ...
    /** Sets the value of the 'total_size' field */
    public avro.java.gpudb.status_response.Builder setTotalSize(long value) {
    ...
    public avro.java.gpudb.status_response.Builder clearTotalSize() {
    ...
    /** Sets the value of the 'total_full_size' field */
    public avro.java.gpudb.status_response.Builder setTotalFullSize(long value) {
    ...
    public avro.java.gpudb.status_response.Builder clearTotalFullSize() {
    ...
    public status_response build() {
      try {
        ...
        record.sizes = fieldSetFlags()[5] ? this.sizes : (java.util.List<java.lang.Long>) defaultValue(fields()[5]);
        record.full_sizes = fieldSetFlags()[6] ? this.full_sizes : (java.util.List<java.lang.Long>) defaultValue(fields()[6]);
        ...
        record.total_size = fieldSetFlags()[8] ? this.total_size : (java.lang.Long) defaultValue(fields()[8]);
        record.total_full_size = fieldSetFlags()[9] ? this.total_full_size : (java.lang.Long) defaultValue(fields()[9]);
        return record;
      } catch (Exception e) {
