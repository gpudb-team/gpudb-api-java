...
public class stats_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"stats_request\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"set_id\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gpudb.stats_request.Builder newBuilder() {
    return new avro.java.gpudb.stats_request.Builder();
  }
  
  /** Creates a new stats_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.stats_request.Builder newBuilder(avro.java.gpudb.stats_request.Builder other) {
    return new avro.java.gpudb.stats_request.Builder(other);
  }
  
  /** Creates a new stats_request RecordBuilder by copying an existing stats_request instance */
  public static avro.java.gpudb.stats_request.Builder newBuilder(avro.java.gpudb.stats_request other) {
    return new avro.java.gpudb.stats_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<stats_request>
    ...
    private Builder() {
      super(avro.java.gpudb.stats_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.stats_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing stats_request instance */
    private Builder(avro.java.gpudb.stats_request other) {
            super(avro.java.gpudb.stats_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.stats_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.stats_request.Builder clearSetId() {
      set_id = null;
