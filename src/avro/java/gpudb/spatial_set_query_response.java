...
public class spatial_set_query_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Creates a new spatial_set_query_response RecordBuilder */
  public static avro.java.gpudb.spatial_set_query_response.Builder newBuilder() {
    return new avro.java.gpudb.spatial_set_query_response.Builder();
  }
  
  /** Creates a new spatial_set_query_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.spatial_set_query_response.Builder newBuilder(avro.java.gpudb.spatial_set_query_response.Builder other) {
    return new avro.java.gpudb.spatial_set_query_response.Builder(other);
  }
  
  /** Creates a new spatial_set_query_response RecordBuilder by copying an existing spatial_set_query_response instance */
  public static avro.java.gpudb.spatial_set_query_response.Builder newBuilder(avro.java.gpudb.spatial_set_query_response other) {
    return new avro.java.gpudb.spatial_set_query_response.Builder(other);
  }
  
  /**
   * RecordBuilder for spatial_set_query_response instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<spatial_set_query_response>
    implements org.apache.avro.data.RecordBuilder<spatial_set_query_response> {
    ...
    private Builder() {
      super(avro.java.gpudb.spatial_set_query_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.spatial_set_query_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing spatial_set_query_response instance */
    private Builder(avro.java.gpudb.spatial_set_query_response other) {
            super(avro.java.gpudb.spatial_set_query_response.SCHEMA$);
    ...
    /** Sets the value of the 'wkt_strings_1' field */
    public avro.java.gpudb.spatial_set_query_response.Builder setWktStrings1(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.spatial_set_query_response.Builder clearWktStrings1() {
      wkt_strings_1 = null;
    ...
    /** Sets the value of the 'group_ids_1' field */
    public avro.java.gpudb.spatial_set_query_response.Builder setGroupIds1(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.spatial_set_query_response.Builder clearGroupIds1() {
      group_ids_1 = null;
    ...
    /** Sets the value of the 'set_ids_1' field */
    public avro.java.gpudb.spatial_set_query_response.Builder setSetIds1(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.spatial_set_query_response.Builder clearSetIds1() {
      set_ids_1 = null;
    ...
    /** Sets the value of the 'wkt_strings_2' field */
    public avro.java.gpudb.spatial_set_query_response.Builder setWktStrings2(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.spatial_set_query_response.Builder clearWktStrings2() {
      wkt_strings_2 = null;
    ...
    /** Sets the value of the 'group_ids_2' field */
    public avro.java.gpudb.spatial_set_query_response.Builder setGroupIds2(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.spatial_set_query_response.Builder clearGroupIds2() {
      group_ids_2 = null;
    ...
    /** Sets the value of the 'set_ids_2' field */
    public avro.java.gpudb.spatial_set_query_response.Builder setSetIds2(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.spatial_set_query_response.Builder clearSetIds2() {
      set_ids_2 = null;
    ...
    @Override
    public spatial_set_query_response build() {
      try {
        spatial_set_query_response record = new spatial_set_query_response();
