...
public class get_type_info_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"get_type_info_response\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"type_ids\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"type_schemas\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"labels\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"semantic_types\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"annotations\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"map\",\"values\":{\"type\":\"array\",\"items\":\"string\"}}}}]}");
   ...
   */
  public get_type_info_response(java.util.List<java.lang.CharSequence> type_ids, java.util.List<java.lang.CharSequence> type_schemas, java.util.List<java.lang.CharSequence> labels, java.util.List<java.lang.CharSequence> semantic_types, java.util.List<java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>> annotations) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: annotations = (java.util.List<java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static avro.java.gpudb.get_type_info_response.Builder newBuilder() {
    return new avro.java.gpudb.get_type_info_response.Builder();
  }
  
  /** Creates a new get_type_info_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.get_type_info_response.Builder newBuilder(avro.java.gpudb.get_type_info_response.Builder other) {
    return new avro.java.gpudb.get_type_info_response.Builder(other);
  }
  
  /** Creates a new get_type_info_response RecordBuilder by copying an existing get_type_info_response instance */
  public static avro.java.gpudb.get_type_info_response.Builder newBuilder(avro.java.gpudb.get_type_info_response other) {
    return new avro.java.gpudb.get_type_info_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<get_type_info_response>
    ...
    private Builder() {
      super(avro.java.gpudb.get_type_info_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.get_type_info_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing get_type_info_response instance */
    private Builder(avro.java.gpudb.get_type_info_response other) {
            super(avro.java.gpudb.get_type_info_response.SCHEMA$);
      ...
      if (isValidValue(fields()[4], other.annotations)) {
        this.annotations = (java.util.List<java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>>) data().deepCopy(fields()[4].schema(), other.annotations);
    ...
    /** Sets the value of the 'type_ids' field */
    public avro.java.gpudb.get_type_info_response.Builder setTypeIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.get_type_info_response.Builder clearTypeIds() {
      type_ids = null;
    ...
    /** Sets the value of the 'type_schemas' field */
    public avro.java.gpudb.get_type_info_response.Builder setTypeSchemas(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.get_type_info_response.Builder clearTypeSchemas() {
      type_schemas = null;
    ...
    /** Sets the value of the 'labels' field */
    public avro.java.gpudb.get_type_info_response.Builder setLabels(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.get_type_info_response.Builder clearLabels() {
      labels = null;
    ...
    /** Sets the value of the 'semantic_types' field */
    public avro.java.gpudb.get_type_info_response.Builder setSemanticTypes(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.get_type_info_response.Builder clearSemanticTypes() {
      semantic_types = null;
    ...
    /** Sets the value of the 'annotations' field */
    public avro.java.gpudb.get_type_info_response.Builder setAnnotations(java.util.List<java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>> value) {
    ...
    public avro.java.gpudb.get_type_info_response.Builder clearAnnotations() {
      annotations = null;
    ...
    public get_type_info_response build() {
      try {
        ...
        record.annotations = fieldSetFlags()[4] ? this.annotations : (java.util.List<java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>>>) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
