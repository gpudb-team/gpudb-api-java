...
public class group_by_map_page_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"group_by_map_page_response\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"count_map\",\"type\":{\"type\":\"map\",\"values\":{\"type\":\"array\",\"items\":\"string\"}}},{\"name\":\"parent_set_id\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gpudb.group_by_map_page_response.Builder newBuilder() {
    return new avro.java.gpudb.group_by_map_page_response.Builder();
  }
  
  /** Creates a new group_by_map_page_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.group_by_map_page_response.Builder newBuilder(avro.java.gpudb.group_by_map_page_response.Builder other) {
    return new avro.java.gpudb.group_by_map_page_response.Builder(other);
  }
  
  /** Creates a new group_by_map_page_response RecordBuilder by copying an existing group_by_map_page_response instance */
  public static avro.java.gpudb.group_by_map_page_response.Builder newBuilder(avro.java.gpudb.group_by_map_page_response other) {
    return new avro.java.gpudb.group_by_map_page_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<group_by_map_page_response>
    ...
    private Builder() {
      super(avro.java.gpudb.group_by_map_page_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.group_by_map_page_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing group_by_map_page_response instance */
    private Builder(avro.java.gpudb.group_by_map_page_response other) {
            super(avro.java.gpudb.group_by_map_page_response.SCHEMA$);
    ...
    /** Sets the value of the 'count_map' field */
    public avro.java.gpudb.group_by_map_page_response.Builder setCountMap(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public avro.java.gpudb.group_by_map_page_response.Builder clearCountMap() {
      count_map = null;
    ...
    /** Sets the value of the 'parent_set_id' field */
    public avro.java.gpudb.group_by_map_page_response.Builder setParentSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.group_by_map_page_response.Builder clearParentSetId() {
      parent_set_id = null;
