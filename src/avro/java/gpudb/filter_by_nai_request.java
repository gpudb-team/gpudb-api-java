...
public class filter_by_nai_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gpudb.filter_by_nai_request.Builder newBuilder() {
    return new avro.java.gpudb.filter_by_nai_request.Builder();
  }
  
  /** Creates a new filter_by_nai_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.filter_by_nai_request.Builder newBuilder(avro.java.gpudb.filter_by_nai_request.Builder other) {
    return new avro.java.gpudb.filter_by_nai_request.Builder(other);
  }
  
  /** Creates a new filter_by_nai_request RecordBuilder by copying an existing filter_by_nai_request instance */
  public static avro.java.gpudb.filter_by_nai_request.Builder newBuilder(avro.java.gpudb.filter_by_nai_request other) {
    return new avro.java.gpudb.filter_by_nai_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<filter_by_nai_request>
    ...
    private Builder() {
      super(avro.java.gpudb.filter_by_nai_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.filter_by_nai_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing filter_by_nai_request instance */
    private Builder(avro.java.gpudb.filter_by_nai_request other) {
            super(avro.java.gpudb.filter_by_nai_request.SCHEMA$);
    ...
    /** Sets the value of the 'result_set_id' field */
    public avro.java.gpudb.filter_by_nai_request.Builder setResultSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.filter_by_nai_request.Builder clearResultSetId() {
      result_set_id = null;
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.filter_by_nai_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.filter_by_nai_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'x_attribute' field */
    public avro.java.gpudb.filter_by_nai_request.Builder setXAttribute(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.filter_by_nai_request.Builder clearXAttribute() {
      x_attribute = null;
    ...
    /** Sets the value of the 'x_vector' field */
    public avro.java.gpudb.filter_by_nai_request.Builder setXVector(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gpudb.filter_by_nai_request.Builder clearXVector() {
      x_vector = null;
    ...
    /** Sets the value of the 'y_attribute' field */
    public avro.java.gpudb.filter_by_nai_request.Builder setYAttribute(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.filter_by_nai_request.Builder clearYAttribute() {
      y_attribute = null;
    ...
    /** Sets the value of the 'y_vector' field */
    public avro.java.gpudb.filter_by_nai_request.Builder setYVector(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gpudb.filter_by_nai_request.Builder clearYVector() {
      y_vector = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gpudb.filter_by_nai_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.filter_by_nai_request.Builder clearUserAuthString() {
