...
public class group_by_value_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Creates a new group_by_value_request RecordBuilder */
  public static avro.java.gpudb.group_by_value_request.Builder newBuilder() {
    return new avro.java.gpudb.group_by_value_request.Builder();
  }
  
  /** Creates a new group_by_value_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.group_by_value_request.Builder newBuilder(avro.java.gpudb.group_by_value_request.Builder other) {
    return new avro.java.gpudb.group_by_value_request.Builder(other);
  }
  
  /** Creates a new group_by_value_request RecordBuilder by copying an existing group_by_value_request instance */
  public static avro.java.gpudb.group_by_value_request.Builder newBuilder(avro.java.gpudb.group_by_value_request other) {
    return new avro.java.gpudb.group_by_value_request.Builder(other);
  }
  
  /**
   * RecordBuilder for group_by_value_request instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<group_by_value_request>
    implements org.apache.avro.data.RecordBuilder<group_by_value_request> {
    ...
    private Builder() {
      super(avro.java.gpudb.group_by_value_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.group_by_value_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing group_by_value_request instance */
    private Builder(avro.java.gpudb.group_by_value_request other) {
            super(avro.java.gpudb.group_by_value_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.group_by_value_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.group_by_value_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'attributes' field */
    public avro.java.gpudb.group_by_value_request.Builder setAttributes(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.group_by_value_request.Builder clearAttributes() {
      attributes = null;
    ...
    /** Sets the value of the 'value_attribute' field */
    public avro.java.gpudb.group_by_value_request.Builder setValueAttribute(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.group_by_value_request.Builder clearValueAttribute() {
    ...
    @Override
    public group_by_value_request build() {
      try {
        group_by_value_request record = new group_by_value_request();
