...
public class bulk_update_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"bulk_update_response\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"count_updated\",\"type\":\"long\"},{\"name\":\"counts_updated\",\"type\":{\"type\":\"array\",\"items\":\"long\"}},{\"name\":\"count_inserted\",\"type\":\"long\"},{\"name\":\"counts_inserted\",\"type\":{\"type\":\"array\",\"items\":\"long\"}}]}");
   ...
   * Default constructor.
   */
  public bulk_update_response() {}

  /**
   * All-args constructor.
   */
  public bulk_update_response(java.lang.Long count_updated, java.util.List<java.lang.Long> counts_updated, java.lang.Long count_inserted, java.util.List<java.lang.Long> counts_inserted) {
  ...
  /** Creates a new bulk_update_response RecordBuilder */
  public static avro.java.gpudb.bulk_update_response.Builder newBuilder() {
    return new avro.java.gpudb.bulk_update_response.Builder();
  }
  
  /** Creates a new bulk_update_response RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.bulk_update_response.Builder newBuilder(avro.java.gpudb.bulk_update_response.Builder other) {
    return new avro.java.gpudb.bulk_update_response.Builder(other);
  }
  
  /** Creates a new bulk_update_response RecordBuilder by copying an existing bulk_update_response instance */
  public static avro.java.gpudb.bulk_update_response.Builder newBuilder(avro.java.gpudb.bulk_update_response other) {
    return new avro.java.gpudb.bulk_update_response.Builder(other);
  }
  
  /**
   * RecordBuilder for bulk_update_response instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<bulk_update_response>
    implements org.apache.avro.data.RecordBuilder<bulk_update_response> {
    ...
    private Builder() {
      super(avro.java.gpudb.bulk_update_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.bulk_update_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing bulk_update_response instance */
    private Builder(avro.java.gpudb.bulk_update_response other) {
            super(avro.java.gpudb.bulk_update_response.SCHEMA$);
    ...
    /** Sets the value of the 'count_updated' field */
    public avro.java.gpudb.bulk_update_response.Builder setCountUpdated(long value) {
    ...
    public avro.java.gpudb.bulk_update_response.Builder clearCountUpdated() {
    ...
    /** Sets the value of the 'counts_updated' field */
    public avro.java.gpudb.bulk_update_response.Builder setCountsUpdated(java.util.List<java.lang.Long> value) {
    ...
    public avro.java.gpudb.bulk_update_response.Builder clearCountsUpdated() {
      counts_updated = null;
    ...
    /** Sets the value of the 'count_inserted' field */
    public avro.java.gpudb.bulk_update_response.Builder setCountInserted(long value) {
    ...
    public avro.java.gpudb.bulk_update_response.Builder clearCountInserted() {
    ...
    /** Sets the value of the 'counts_inserted' field */
    public avro.java.gpudb.bulk_update_response.Builder setCountsInserted(java.util.List<java.lang.Long> value) {
    ...
    public avro.java.gpudb.bulk_update_response.Builder clearCountsInserted() {
    ...
    @Override
    public bulk_update_response build() {
      try {
        bulk_update_response record = new bulk_update_response();
