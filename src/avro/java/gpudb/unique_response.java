...
public class unique_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gpudb.unique_response.Builder newBuilder(avro.java.gpudb.unique_response.Builder other) {
    return new avro.java.gpudb.unique_response.Builder(other);
  }
  
  /** Creates a new unique_response RecordBuilder by copying an existing unique_response instance */
  public static avro.java.gpudb.unique_response.Builder newBuilder(avro.java.gpudb.unique_response other) {
    return new avro.java.gpudb.unique_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<unique_response>
    ...
    private Builder() {
      super(avro.java.gpudb.unique_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.unique_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing unique_response instance */
    private Builder(avro.java.gpudb.unique_response other) {
            super(avro.java.gpudb.unique_response.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.unique_response.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.unique_response.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'attribute' field */
    public avro.java.gpudb.unique_response.Builder setAttribute(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.unique_response.Builder clearAttribute() {
      attribute = null;
    ...
    /** Sets the value of the 'values' field */
    public avro.java.gpudb.unique_response.Builder setValues(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gpudb.unique_response.Builder clearValues() {
      values = null;
    ...
    /** Sets the value of the 'values_str' field */
    public avro.java.gpudb.unique_response.Builder setValuesStr(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.unique_response.Builder clearValuesStr() {
      values_str = null;
    ...
    /** Sets the value of the 'is_string' field */
    public avro.java.gpudb.unique_response.Builder setIsString(boolean value) {
    ...
    public avro.java.gpudb.unique_response.Builder clearIsString() {
