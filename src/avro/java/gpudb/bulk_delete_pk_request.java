...
public class bulk_delete_pk_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"bulk_delete_pk_request\",\"namespace\":\"avro.java.gpudb\",\"fields\":[{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"pk_expressions\",\"type\":{\"type\":\"map\",\"values\":{\"type\":\"array\",\"items\":\"string\"}}},{\"name\":\"params\",\"type\":{\"type\":\"map\",\"values\":\"string\"}},{\"name\":\"user_auth_string\",\"type\":\"string\"}]}");
   ...
   * Default constructor.
   */
  public bulk_delete_pk_request() {}

  /**
   * All-args constructor.
   */
  public bulk_delete_pk_request(java.lang.CharSequence set_id, java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> pk_expressions, java.util.Map<java.lang.CharSequence,java.lang.CharSequence> params, java.lang.CharSequence user_auth_string) {
    this.set_id = set_id;
  ...
  /** Creates a new bulk_delete_pk_request RecordBuilder */
  public static avro.java.gpudb.bulk_delete_pk_request.Builder newBuilder() {
    return new avro.java.gpudb.bulk_delete_pk_request.Builder();
  }
  
  /** Creates a new bulk_delete_pk_request RecordBuilder by copying an existing Builder */
  public static avro.java.gpudb.bulk_delete_pk_request.Builder newBuilder(avro.java.gpudb.bulk_delete_pk_request.Builder other) {
    return new avro.java.gpudb.bulk_delete_pk_request.Builder(other);
  }
  
  /** Creates a new bulk_delete_pk_request RecordBuilder by copying an existing bulk_delete_pk_request instance */
  public static avro.java.gpudb.bulk_delete_pk_request.Builder newBuilder(avro.java.gpudb.bulk_delete_pk_request other) {
    return new avro.java.gpudb.bulk_delete_pk_request.Builder(other);
  }
  
  /**
   * RecordBuilder for bulk_delete_pk_request instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<bulk_delete_pk_request>
    implements org.apache.avro.data.RecordBuilder<bulk_delete_pk_request> {
    ...
    private Builder() {
      super(avro.java.gpudb.bulk_delete_pk_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gpudb.bulk_delete_pk_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing bulk_delete_pk_request instance */
    private Builder(avro.java.gpudb.bulk_delete_pk_request other) {
            super(avro.java.gpudb.bulk_delete_pk_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gpudb.bulk_delete_pk_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.bulk_delete_pk_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'pk_expressions' field */
    public avro.java.gpudb.bulk_delete_pk_request.Builder setPkExpressions(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public avro.java.gpudb.bulk_delete_pk_request.Builder clearPkExpressions() {
      pk_expressions = null;
    ...
    /** Sets the value of the 'params' field */
    public avro.java.gpudb.bulk_delete_pk_request.Builder setParams(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public avro.java.gpudb.bulk_delete_pk_request.Builder clearParams() {
      params = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gpudb.bulk_delete_pk_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gpudb.bulk_delete_pk_request.Builder clearUserAuthString() {
    ...
    @Override
    public bulk_delete_pk_request build() {
      try {
        bulk_delete_pk_request record = new bulk_delete_pk_request();
