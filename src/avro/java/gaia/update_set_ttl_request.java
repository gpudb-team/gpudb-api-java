...
public class update_set_ttl_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"update_set_ttl_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"ttl\",\"type\":\"int\"}]}");
  ...
  public static avro.java.gaia.update_set_ttl_request.Builder newBuilder() {
    return new avro.java.gaia.update_set_ttl_request.Builder();
  }
  
  /** Creates a new update_set_ttl_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.update_set_ttl_request.Builder newBuilder(avro.java.gaia.update_set_ttl_request.Builder other) {
    return new avro.java.gaia.update_set_ttl_request.Builder(other);
  }
  
  /** Creates a new update_set_ttl_request RecordBuilder by copying an existing update_set_ttl_request instance */
  public static avro.java.gaia.update_set_ttl_request.Builder newBuilder(avro.java.gaia.update_set_ttl_request other) {
    return new avro.java.gaia.update_set_ttl_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<update_set_ttl_request>
    ...
    private Builder() {
      super(avro.java.gaia.update_set_ttl_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.update_set_ttl_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing update_set_ttl_request instance */
    private Builder(avro.java.gaia.update_set_ttl_request other) {
            super(avro.java.gaia.update_set_ttl_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.update_set_ttl_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.update_set_ttl_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'ttl' field */
    public avro.java.gaia.update_set_ttl_request.Builder setTtl(int value) {
    ...
    public avro.java.gaia.update_set_ttl_request.Builder clearTtl() {
