...
public class get_set_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"get_set_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"start\",\"type\":\"int\"},{\"name\":\"end\",\"type\":\"int\"},{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"semantic_type\",\"type\":\"string\"},{\"name\":\"user_auth_string\",\"type\":\"string\"}]}");
   ...
   */
  public get_set_request(java.lang.Integer start, java.lang.Integer end, java.lang.CharSequence set_id, java.lang.CharSequence semantic_type, java.lang.CharSequence user_auth_string) {
    this.start = start;
    this.end = end;
    this.set_id = set_id;
  ...
  public static avro.java.gaia.get_set_request.Builder newBuilder() {
    return new avro.java.gaia.get_set_request.Builder();
  }
  
  /** Creates a new get_set_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.get_set_request.Builder newBuilder(avro.java.gaia.get_set_request.Builder other) {
    return new avro.java.gaia.get_set_request.Builder(other);
  }
  
  /** Creates a new get_set_request RecordBuilder by copying an existing get_set_request instance */
  public static avro.java.gaia.get_set_request.Builder newBuilder(avro.java.gaia.get_set_request other) {
    return new avro.java.gaia.get_set_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<get_set_request>
    ...
    private Builder() {
      super(avro.java.gaia.get_set_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.get_set_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing get_set_request instance */
    private Builder(avro.java.gaia.get_set_request other) {
            super(avro.java.gaia.get_set_request.SCHEMA$);
    ...
    /** Sets the value of the 'start' field */
    public avro.java.gaia.get_set_request.Builder setStart(int value) {
    ...
    public avro.java.gaia.get_set_request.Builder clearStart() {
    ...
    /** Sets the value of the 'end' field */
    public avro.java.gaia.get_set_request.Builder setEnd(int value) {
    ...
    public avro.java.gaia.get_set_request.Builder clearEnd() {
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.get_set_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.get_set_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'semantic_type' field */
    public avro.java.gaia.get_set_request.Builder setSemanticType(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.get_set_request.Builder clearSemanticType() {
      semantic_type = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gaia.get_set_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.get_set_request.Builder clearUserAuthString() {
