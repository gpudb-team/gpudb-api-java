...
public class max_min_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"max_min_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"attribute\",\"type\":\"string\"},{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"user_auth_string\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.max_min_request.Builder newBuilder() {
    return new avro.java.gaia.max_min_request.Builder();
  }
  
  /** Creates a new max_min_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.max_min_request.Builder newBuilder(avro.java.gaia.max_min_request.Builder other) {
    return new avro.java.gaia.max_min_request.Builder(other);
  }
  
  /** Creates a new max_min_request RecordBuilder by copying an existing max_min_request instance */
  public static avro.java.gaia.max_min_request.Builder newBuilder(avro.java.gaia.max_min_request other) {
    return new avro.java.gaia.max_min_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<max_min_request>
    ...
    private Builder() {
      super(avro.java.gaia.max_min_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.max_min_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing max_min_request instance */
    private Builder(avro.java.gaia.max_min_request other) {
            super(avro.java.gaia.max_min_request.SCHEMA$);
    ...
    /** Sets the value of the 'attribute' field */
    public avro.java.gaia.max_min_request.Builder setAttribute(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.max_min_request.Builder clearAttribute() {
      attribute = null;
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.max_min_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.max_min_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gaia.max_min_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.max_min_request.Builder clearUserAuthString() {
