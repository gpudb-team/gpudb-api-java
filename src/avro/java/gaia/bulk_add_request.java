...
public class bulk_add_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"bulk_add_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"list\",\"type\":{\"type\":\"array\",\"items\":\"bytes\"}},{\"name\":\"list_str\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"list_encoding\",\"type\":\"string\"}]}");
   ...
   */
  public bulk_add_request(java.lang.CharSequence set_id, java.util.List<java.nio.ByteBuffer> list, java.util.List<java.lang.CharSequence> list_str, java.lang.CharSequence list_encoding) {
    this.set_id = set_id;
    this.list = list;
  ...
  public static avro.java.gaia.bulk_add_request.Builder newBuilder() {
    return new avro.java.gaia.bulk_add_request.Builder();
  }
  
  /** Creates a new bulk_add_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.bulk_add_request.Builder newBuilder(avro.java.gaia.bulk_add_request.Builder other) {
    return new avro.java.gaia.bulk_add_request.Builder(other);
  }
  
  /** Creates a new bulk_add_request RecordBuilder by copying an existing bulk_add_request instance */
  public static avro.java.gaia.bulk_add_request.Builder newBuilder(avro.java.gaia.bulk_add_request other) {
    return new avro.java.gaia.bulk_add_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<bulk_add_request>
    ...
    private Builder() {
      super(avro.java.gaia.bulk_add_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.bulk_add_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing bulk_add_request instance */
    private Builder(avro.java.gaia.bulk_add_request other) {
            super(avro.java.gaia.bulk_add_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.bulk_add_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.bulk_add_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'list' field */
    public avro.java.gaia.bulk_add_request.Builder setList(java.util.List<java.nio.ByteBuffer> value) {
    ...
    public avro.java.gaia.bulk_add_request.Builder clearList() {
      list = null;
    ...
    /** Sets the value of the 'list_str' field */
    public avro.java.gaia.bulk_add_request.Builder setListStr(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gaia.bulk_add_request.Builder clearListStr() {
      list_str = null;
    ...
    /** Sets the value of the 'list_encoding' field */
    public avro.java.gaia.bulk_add_request.Builder setListEncoding(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.bulk_add_request.Builder clearListEncoding() {
      list_encoding = null;
