...
public class update_object_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gaia.update_object_request.Builder newBuilder() {
    return new avro.java.gaia.update_object_request.Builder();
  }
  
  /** Creates a new update_object_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.update_object_request.Builder newBuilder(avro.java.gaia.update_object_request.Builder other) {
    return new avro.java.gaia.update_object_request.Builder(other);
  }
  
  /** Creates a new update_object_request RecordBuilder by copying an existing update_object_request instance */
  public static avro.java.gaia.update_object_request.Builder newBuilder(avro.java.gaia.update_object_request other) {
    return new avro.java.gaia.update_object_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<update_object_request>
    ...
    private Builder() {
      super(avro.java.gaia.update_object_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.update_object_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing update_object_request instance */
    private Builder(avro.java.gaia.update_object_request other) {
            super(avro.java.gaia.update_object_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_ids' field */
    public avro.java.gaia.update_object_request.Builder setSetIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gaia.update_object_request.Builder clearSetIds() {
      set_ids = null;
    ...
    /** Sets the value of the 'OBJECT_ID' field */
    public avro.java.gaia.update_object_request.Builder setOBJECTID(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.update_object_request.Builder clearOBJECTID() {
      OBJECT_ID = null;
    ...
    /** Sets the value of the 'object_data' field */
    public avro.java.gaia.update_object_request.Builder setObjectData(java.nio.ByteBuffer value) {
    ...
    public avro.java.gaia.update_object_request.Builder clearObjectData() {
      object_data = null;
    ...
    /** Sets the value of the 'object_data_str' field */
    public avro.java.gaia.update_object_request.Builder setObjectDataStr(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.update_object_request.Builder clearObjectDataStr() {
    ...
    /** Sets the value of the 'object_encoding' field */
    public avro.java.gaia.update_object_request.Builder setObjectEncoding(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.update_object_request.Builder clearObjectEncoding() {
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gaia.update_object_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.update_object_request.Builder clearUserAuthString() {
