...
public class predicate_join_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"predicate_join_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"count\",\"type\":\"int\"}]}");
  ...
  public static avro.java.gaia.predicate_join_response.Builder newBuilder() {
    return new avro.java.gaia.predicate_join_response.Builder();
  }
  
  /** Creates a new predicate_join_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.predicate_join_response.Builder newBuilder(avro.java.gaia.predicate_join_response.Builder other) {
    return new avro.java.gaia.predicate_join_response.Builder(other);
  }
  
  /** Creates a new predicate_join_response RecordBuilder by copying an existing predicate_join_response instance */
  public static avro.java.gaia.predicate_join_response.Builder newBuilder(avro.java.gaia.predicate_join_response other) {
    return new avro.java.gaia.predicate_join_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<predicate_join_response>
    ...
    private Builder() {
      super(avro.java.gaia.predicate_join_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.predicate_join_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing predicate_join_response instance */
    private Builder(avro.java.gaia.predicate_join_response other) {
            super(avro.java.gaia.predicate_join_response.SCHEMA$);
    ...
    /** Sets the value of the 'count' field */
    public avro.java.gaia.predicate_join_response.Builder setCount(int value) {
    ...
    public avro.java.gaia.predicate_join_response.Builder clearCount() {
