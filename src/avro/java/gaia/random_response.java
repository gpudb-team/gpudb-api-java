...
public class random_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"random_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"count\",\"type\":\"int\"}]}");
   ...
   */
  public random_response(java.lang.CharSequence set_id, java.lang.Integer count) {
    this.set_id = set_id;
    this.count = count;
  }
  ...
  public static avro.java.gaia.random_response.Builder newBuilder() {
    return new avro.java.gaia.random_response.Builder();
  }
  
  /** Creates a new random_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.random_response.Builder newBuilder(avro.java.gaia.random_response.Builder other) {
    return new avro.java.gaia.random_response.Builder(other);
  }
  
  /** Creates a new random_response RecordBuilder by copying an existing random_response instance */
  public static avro.java.gaia.random_response.Builder newBuilder(avro.java.gaia.random_response other) {
    return new avro.java.gaia.random_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<random_response>
    ...
    private Builder() {
      super(avro.java.gaia.random_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.random_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing random_response instance */
    private Builder(avro.java.gaia.random_response other) {
            super(avro.java.gaia.random_response.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.random_response.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.random_response.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'count' field */
    public avro.java.gaia.random_response.Builder setCount(int value) {
    ...
    public avro.java.gaia.random_response.Builder clearCount() {
