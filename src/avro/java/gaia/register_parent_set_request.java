...
public class register_parent_set_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"register_parent_set_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"allow_duplicate_children\",\"type\":\"boolean\"}]}");
  ...
  public static avro.java.gaia.register_parent_set_request.Builder newBuilder() {
    return new avro.java.gaia.register_parent_set_request.Builder();
  }
  
  /** Creates a new register_parent_set_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.register_parent_set_request.Builder newBuilder(avro.java.gaia.register_parent_set_request.Builder other) {
    return new avro.java.gaia.register_parent_set_request.Builder(other);
  }
  
  /** Creates a new register_parent_set_request RecordBuilder by copying an existing register_parent_set_request instance */
  public static avro.java.gaia.register_parent_set_request.Builder newBuilder(avro.java.gaia.register_parent_set_request other) {
    return new avro.java.gaia.register_parent_set_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<register_parent_set_request>
    ...
    private Builder() {
      super(avro.java.gaia.register_parent_set_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.register_parent_set_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing register_parent_set_request instance */
    private Builder(avro.java.gaia.register_parent_set_request other) {
            super(avro.java.gaia.register_parent_set_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.register_parent_set_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.register_parent_set_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'allow_duplicate_children' field */
    public avro.java.gaia.register_parent_set_request.Builder setAllowDuplicateChildren(boolean value) {
    ...
    public avro.java.gaia.register_parent_set_request.Builder clearAllowDuplicateChildren() {
