...
public class filter_by_bounds_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"filter_by_bounds_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"count\",\"type\":\"int\"}]}");
   ...
   */
  public filter_by_bounds_response(java.lang.Integer count) {
    this.count = count;
  }
  ...
  public static avro.java.gaia.filter_by_bounds_response.Builder newBuilder() {
    return new avro.java.gaia.filter_by_bounds_response.Builder();
  }
  
  /** Creates a new filter_by_bounds_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.filter_by_bounds_response.Builder newBuilder(avro.java.gaia.filter_by_bounds_response.Builder other) {
    return new avro.java.gaia.filter_by_bounds_response.Builder(other);
  }
  
  /** Creates a new filter_by_bounds_response RecordBuilder by copying an existing filter_by_bounds_response instance */
  public static avro.java.gaia.filter_by_bounds_response.Builder newBuilder(avro.java.gaia.filter_by_bounds_response other) {
    return new avro.java.gaia.filter_by_bounds_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<filter_by_bounds_response>
    ...
    private Builder() {
      super(avro.java.gaia.filter_by_bounds_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.filter_by_bounds_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing filter_by_bounds_response instance */
    private Builder(avro.java.gaia.filter_by_bounds_response other) {
            super(avro.java.gaia.filter_by_bounds_response.SCHEMA$);
    ...
    /** Sets the value of the 'count' field */
    public avro.java.gaia.filter_by_bounds_response.Builder setCount(int value) {
    ...
    public avro.java.gaia.filter_by_bounds_response.Builder clearCount() {
