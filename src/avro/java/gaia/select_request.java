...
public class select_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"select_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"expression\",\"type\":\"string\"},{\"name\":\"result_set_id\",\"type\":\"string\"},{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"user_auth_string\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.select_request.Builder newBuilder() {
    return new avro.java.gaia.select_request.Builder();
  }
  
  /** Creates a new select_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.select_request.Builder newBuilder(avro.java.gaia.select_request.Builder other) {
    return new avro.java.gaia.select_request.Builder(other);
  }
  
  /** Creates a new select_request RecordBuilder by copying an existing select_request instance */
  public static avro.java.gaia.select_request.Builder newBuilder(avro.java.gaia.select_request other) {
    return new avro.java.gaia.select_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<select_request>
    ...
    private Builder() {
      super(avro.java.gaia.select_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.select_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing select_request instance */
    private Builder(avro.java.gaia.select_request other) {
            super(avro.java.gaia.select_request.SCHEMA$);
    ...
    /** Sets the value of the 'expression' field */
    public avro.java.gaia.select_request.Builder setExpression(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.select_request.Builder clearExpression() {
      expression = null;
    ...
    /** Sets the value of the 'result_set_id' field */
    public avro.java.gaia.select_request.Builder setResultSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.select_request.Builder clearResultSetId() {
      result_set_id = null;
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.select_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.select_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gaia.select_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.select_request.Builder clearUserAuthString() {
