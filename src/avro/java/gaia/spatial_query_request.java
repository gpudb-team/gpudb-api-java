...
public class spatial_query_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"spatial_query_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"wkt_string_1\",\"type\":\"string\"},{\"name\":\"wkt_string_2\",\"type\":\"string\"},{\"name\":\"operation\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.spatial_query_request.Builder newBuilder() {
    return new avro.java.gaia.spatial_query_request.Builder();
  }
  
  /** Creates a new spatial_query_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.spatial_query_request.Builder newBuilder(avro.java.gaia.spatial_query_request.Builder other) {
    return new avro.java.gaia.spatial_query_request.Builder(other);
  }
  
  /** Creates a new spatial_query_request RecordBuilder by copying an existing spatial_query_request instance */
  public static avro.java.gaia.spatial_query_request.Builder newBuilder(avro.java.gaia.spatial_query_request other) {
    return new avro.java.gaia.spatial_query_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<spatial_query_request>
    ...
    private Builder() {
      super(avro.java.gaia.spatial_query_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.spatial_query_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing spatial_query_request instance */
    private Builder(avro.java.gaia.spatial_query_request other) {
            super(avro.java.gaia.spatial_query_request.SCHEMA$);
    ...
    /** Sets the value of the 'wkt_string_1' field */
    public avro.java.gaia.spatial_query_request.Builder setWktString1(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.spatial_query_request.Builder clearWktString1() {
      wkt_string_1 = null;
    ...
    /** Sets the value of the 'wkt_string_2' field */
    public avro.java.gaia.spatial_query_request.Builder setWktString2(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.spatial_query_request.Builder clearWktString2() {
      wkt_string_2 = null;
    ...
    /** Sets the value of the 'operation' field */
    public avro.java.gaia.spatial_query_request.Builder setOperation(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.spatial_query_request.Builder clearOperation() {
      operation = null;
