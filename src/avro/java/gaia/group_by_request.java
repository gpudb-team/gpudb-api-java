...
public class group_by_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"group_by_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"set_id\",\"type\":\"string\"},{\"name\":\"attributes\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"user_auth_string\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.group_by_request.Builder newBuilder() {
    return new avro.java.gaia.group_by_request.Builder();
  }
  
  /** Creates a new group_by_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.group_by_request.Builder newBuilder(avro.java.gaia.group_by_request.Builder other) {
    return new avro.java.gaia.group_by_request.Builder(other);
  }
  
  /** Creates a new group_by_request RecordBuilder by copying an existing group_by_request instance */
  public static avro.java.gaia.group_by_request.Builder newBuilder(avro.java.gaia.group_by_request other) {
    return new avro.java.gaia.group_by_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<group_by_request>
    ...
    private Builder() {
      super(avro.java.gaia.group_by_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.group_by_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing group_by_request instance */
    private Builder(avro.java.gaia.group_by_request other) {
            super(avro.java.gaia.group_by_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.group_by_request.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.group_by_request.Builder clearSetId() {
      set_id = null;
    ...
    /** Sets the value of the 'attributes' field */
    public avro.java.gaia.group_by_request.Builder setAttributes(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gaia.group_by_request.Builder clearAttributes() {
      attributes = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gaia.group_by_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.group_by_request.Builder clearUserAuthString() {
