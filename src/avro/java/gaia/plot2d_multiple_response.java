...
public class plot2d_multiple_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"plot2d_multiple_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"width\",\"type\":\"double\"},{\"name\":\"height\",\"type\":\"double\"},{\"name\":\"bg_color\",\"type\":\"long\"},{\"name\":\"image_data\",\"type\":\"bytes\"}]}");
  ...
  public static avro.java.gaia.plot2d_multiple_response.Builder newBuilder() {
    return new avro.java.gaia.plot2d_multiple_response.Builder();
  }
  
  /** Creates a new plot2d_multiple_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.plot2d_multiple_response.Builder newBuilder(avro.java.gaia.plot2d_multiple_response.Builder other) {
    return new avro.java.gaia.plot2d_multiple_response.Builder(other);
  }
  
  /** Creates a new plot2d_multiple_response RecordBuilder by copying an existing plot2d_multiple_response instance */
  public static avro.java.gaia.plot2d_multiple_response.Builder newBuilder(avro.java.gaia.plot2d_multiple_response other) {
    return new avro.java.gaia.plot2d_multiple_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<plot2d_multiple_response>
    ...
    private Builder() {
      super(avro.java.gaia.plot2d_multiple_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.plot2d_multiple_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing plot2d_multiple_response instance */
    private Builder(avro.java.gaia.plot2d_multiple_response other) {
            super(avro.java.gaia.plot2d_multiple_response.SCHEMA$);
    ...
    /** Sets the value of the 'width' field */
    public avro.java.gaia.plot2d_multiple_response.Builder setWidth(double value) {
    ...
    public avro.java.gaia.plot2d_multiple_response.Builder clearWidth() {
    ...
    /** Sets the value of the 'height' field */
    public avro.java.gaia.plot2d_multiple_response.Builder setHeight(double value) {
    ...
    public avro.java.gaia.plot2d_multiple_response.Builder clearHeight() {
    ...
    /** Sets the value of the 'bg_color' field */
    public avro.java.gaia.plot2d_multiple_response.Builder setBgColor(long value) {
    ...
    public avro.java.gaia.plot2d_multiple_response.Builder clearBgColor() {
    ...
    /** Sets the value of the 'image_data' field */
    public avro.java.gaia.plot2d_multiple_response.Builder setImageData(java.nio.ByteBuffer value) {
    ...
    public avro.java.gaia.plot2d_multiple_response.Builder clearImageData() {
      image_data = null;
