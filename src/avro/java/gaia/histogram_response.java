...
public class histogram_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"histogram_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"counts\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"end\",\"type\":\"double\"},{\"name\":\"start\",\"type\":\"double\"}]}");
   ...
   */
  public histogram_response(java.util.List<java.lang.Integer> counts, java.lang.Double end, java.lang.Double start) {
    this.counts = counts;
    this.end = end;
    this.start = start;
  }
  ...
  public static avro.java.gaia.histogram_response.Builder newBuilder() {
    return new avro.java.gaia.histogram_response.Builder();
  }
  
  /** Creates a new histogram_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.histogram_response.Builder newBuilder(avro.java.gaia.histogram_response.Builder other) {
    return new avro.java.gaia.histogram_response.Builder(other);
  }
  
  /** Creates a new histogram_response RecordBuilder by copying an existing histogram_response instance */
  public static avro.java.gaia.histogram_response.Builder newBuilder(avro.java.gaia.histogram_response other) {
    return new avro.java.gaia.histogram_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<histogram_response>
    ...
    private Builder() {
      super(avro.java.gaia.histogram_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.histogram_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing histogram_response instance */
    private Builder(avro.java.gaia.histogram_response other) {
            super(avro.java.gaia.histogram_response.SCHEMA$);
      if (isValidValue(fields()[0], other.counts)) {
        this.counts = (java.util.List<java.lang.Integer>) data().deepCopy(fields()[0].schema(), other.counts);
    ...
    /** Sets the value of the 'counts' field */
    public avro.java.gaia.histogram_response.Builder setCounts(java.util.List<java.lang.Integer> value) {
    ...
    public avro.java.gaia.histogram_response.Builder clearCounts() {
      counts = null;
    ...
    /** Sets the value of the 'end' field */
    public avro.java.gaia.histogram_response.Builder setEnd(double value) {
    ...
    public avro.java.gaia.histogram_response.Builder clearEnd() {
    ...
    /** Sets the value of the 'start' field */
    public avro.java.gaia.histogram_response.Builder setStart(double value) {
    ...
    public avro.java.gaia.histogram_response.Builder clearStart() {
