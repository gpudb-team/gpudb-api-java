...
public class group_by_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"group_by_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"attributes\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"count_map\",\"type\":{\"type\":\"map\",\"values\":{\"type\":\"array\",\"items\":\"string\"}}},{\"name\":\"set_id\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.group_by_response.Builder newBuilder() {
    return new avro.java.gaia.group_by_response.Builder();
  }
  
  /** Creates a new group_by_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.group_by_response.Builder newBuilder(avro.java.gaia.group_by_response.Builder other) {
    return new avro.java.gaia.group_by_response.Builder(other);
  }
  
  /** Creates a new group_by_response RecordBuilder by copying an existing group_by_response instance */
  public static avro.java.gaia.group_by_response.Builder newBuilder(avro.java.gaia.group_by_response other) {
    return new avro.java.gaia.group_by_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<group_by_response>
    ...
    private Builder() {
      super(avro.java.gaia.group_by_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.group_by_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing group_by_response instance */
    private Builder(avro.java.gaia.group_by_response other) {
            super(avro.java.gaia.group_by_response.SCHEMA$);
    ...
    /** Sets the value of the 'attributes' field */
    public avro.java.gaia.group_by_response.Builder setAttributes(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gaia.group_by_response.Builder clearAttributes() {
      attributes = null;
    ...
    /** Sets the value of the 'count_map' field */
    public avro.java.gaia.group_by_response.Builder setCountMap(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public avro.java.gaia.group_by_response.Builder clearCountMap() {
      count_map = null;
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.group_by_response.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.group_by_response.Builder clearSetId() {
      set_id = null;
