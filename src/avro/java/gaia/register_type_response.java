...
public class register_type_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"register_type_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"type_id\",\"type\":\"string\"},{\"name\":\"type_definition\",\"type\":\"string\"},{\"name\":\"annotation\",\"type\":\"string\"},{\"name\":\"label\",\"type\":\"string\"},{\"name\":\"semantic_type\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.register_type_response.Builder newBuilder() {
    return new avro.java.gaia.register_type_response.Builder();
  }
  
  /** Creates a new register_type_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.register_type_response.Builder newBuilder(avro.java.gaia.register_type_response.Builder other) {
    return new avro.java.gaia.register_type_response.Builder(other);
  }
  
  /** Creates a new register_type_response RecordBuilder by copying an existing register_type_response instance */
  public static avro.java.gaia.register_type_response.Builder newBuilder(avro.java.gaia.register_type_response other) {
    return new avro.java.gaia.register_type_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<register_type_response>
    ...
    private Builder() {
      super(avro.java.gaia.register_type_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.register_type_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing register_type_response instance */
    private Builder(avro.java.gaia.register_type_response other) {
            super(avro.java.gaia.register_type_response.SCHEMA$);
    ...
    /** Sets the value of the 'type_id' field */
    public avro.java.gaia.register_type_response.Builder setTypeId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.register_type_response.Builder clearTypeId() {
      type_id = null;
    ...
    /** Sets the value of the 'type_definition' field */
    public avro.java.gaia.register_type_response.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.register_type_response.Builder clearTypeDefinition() {
    ...
    /** Sets the value of the 'annotation' field */
    public avro.java.gaia.register_type_response.Builder setAnnotation(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.register_type_response.Builder clearAnnotation() {
      annotation = null;
    ...
    /** Sets the value of the 'label' field */
    public avro.java.gaia.register_type_response.Builder setLabel(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.register_type_response.Builder clearLabel() {
      label = null;
    ...
    /** Sets the value of the 'semantic_type' field */
    public avro.java.gaia.register_type_response.Builder setSemanticType(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.register_type_response.Builder clearSemanticType() {
      semantic_type = null;
