...
public class gaia_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"gaia_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"status\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"},{\"name\":\"data_type\",\"type\":\"string\"},{\"name\":\"data\",\"type\":\"bytes\"},{\"name\":\"data_str\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.gaia_response.Builder newBuilder() {
    return new avro.java.gaia.gaia_response.Builder();
  }
  
  /** Creates a new gaia_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.gaia_response.Builder newBuilder(avro.java.gaia.gaia_response.Builder other) {
    return new avro.java.gaia.gaia_response.Builder(other);
  }
  
  /** Creates a new gaia_response RecordBuilder by copying an existing gaia_response instance */
  public static avro.java.gaia.gaia_response.Builder newBuilder(avro.java.gaia.gaia_response other) {
    return new avro.java.gaia.gaia_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<gaia_response>
    ...
    private Builder() {
      super(avro.java.gaia.gaia_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.gaia_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing gaia_response instance */
    private Builder(avro.java.gaia.gaia_response other) {
            super(avro.java.gaia.gaia_response.SCHEMA$);
    ...
    /** Sets the value of the 'status' field */
    public avro.java.gaia.gaia_response.Builder setStatus(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.gaia_response.Builder clearStatus() {
      status = null;
    ...
    /** Sets the value of the 'message' field */
    public avro.java.gaia.gaia_response.Builder setMessage(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.gaia_response.Builder clearMessage() {
      message = null;
    ...
    /** Sets the value of the 'data_type' field */
    public avro.java.gaia.gaia_response.Builder setDataType(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.gaia_response.Builder clearDataType() {
      data_type = null;
    ...
    /** Sets the value of the 'data' field */
    public avro.java.gaia.gaia_response.Builder setData(java.nio.ByteBuffer value) {
    ...
    public avro.java.gaia.gaia_response.Builder clearData() {
      data = null;
    ...
    /** Sets the value of the 'data_str' field */
    public avro.java.gaia.gaia_response.Builder setDataStr(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.gaia_response.Builder clearDataStr() {
      data_str = null;
