...
public class filter_then_histogram_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"filter_then_histogram_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"counts\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"array\",\"items\":\"int\"}}},{\"name\":\"end\",\"type\":\"double\"},{\"name\":\"start\",\"type\":\"double\"}]}");
  ...
  public static avro.java.gaia.filter_then_histogram_response.Builder newBuilder() {
    return new avro.java.gaia.filter_then_histogram_response.Builder();
  }
  
  /** Creates a new filter_then_histogram_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.filter_then_histogram_response.Builder newBuilder(avro.java.gaia.filter_then_histogram_response.Builder other) {
    return new avro.java.gaia.filter_then_histogram_response.Builder(other);
  }
  ...
  public static avro.java.gaia.filter_then_histogram_response.Builder newBuilder(avro.java.gaia.filter_then_histogram_response other) {
    return new avro.java.gaia.filter_then_histogram_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<filter_then_histogram_response>
    ...
    private Builder() {
      super(avro.java.gaia.filter_then_histogram_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.filter_then_histogram_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing filter_then_histogram_response instance */
    private Builder(avro.java.gaia.filter_then_histogram_response other) {
            super(avro.java.gaia.filter_then_histogram_response.SCHEMA$);
    ...
    /** Sets the value of the 'counts' field */
    public avro.java.gaia.filter_then_histogram_response.Builder setCounts(java.util.List<java.util.List<java.lang.Integer>> value) {
    ...
    public avro.java.gaia.filter_then_histogram_response.Builder clearCounts() {
      counts = null;
    ...
    /** Sets the value of the 'end' field */
    public avro.java.gaia.filter_then_histogram_response.Builder setEnd(double value) {
    ...
    public avro.java.gaia.filter_then_histogram_response.Builder clearEnd() {
    ...
    /** Sets the value of the 'start' field */
    public avro.java.gaia.filter_then_histogram_response.Builder setStart(double value) {
    ...
    public avro.java.gaia.filter_then_histogram_response.Builder clearStart() {
