...
public class shape_intersection_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gaia.shape_intersection_request.Builder newBuilder() {
    return new avro.java.gaia.shape_intersection_request.Builder();
  }
  
  /** Creates a new shape_intersection_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.shape_intersection_request.Builder newBuilder(avro.java.gaia.shape_intersection_request.Builder other) {
    return new avro.java.gaia.shape_intersection_request.Builder(other);
  }
  
  /** Creates a new shape_intersection_request RecordBuilder by copying an existing shape_intersection_request instance */
  public static avro.java.gaia.shape_intersection_request.Builder newBuilder(avro.java.gaia.shape_intersection_request other) {
    return new avro.java.gaia.shape_intersection_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<shape_intersection_request>
    ...
    private Builder() {
      super(avro.java.gaia.shape_intersection_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.shape_intersection_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing shape_intersection_request instance */
    private Builder(avro.java.gaia.shape_intersection_request other) {
            super(avro.java.gaia.shape_intersection_request.SCHEMA$);
    ...
    /** Sets the value of the 'set_ids' field */
    public avro.java.gaia.shape_intersection_request.Builder setSetIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gaia.shape_intersection_request.Builder clearSetIds() {
      set_ids = null;
    ...
    /** Sets the value of the 'wkt_attr_name' field */
    public avro.java.gaia.shape_intersection_request.Builder setWktAttrName(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.shape_intersection_request.Builder clearWktAttrName() {
      wkt_attr_name = null;
    ...
    /** Sets the value of the 'x_vector' field */
    public avro.java.gaia.shape_intersection_request.Builder setXVector(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gaia.shape_intersection_request.Builder clearXVector() {
      x_vector = null;
    ...
    /** Sets the value of the 'y_vector' field */
    public avro.java.gaia.shape_intersection_request.Builder setYVector(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gaia.shape_intersection_request.Builder clearYVector() {
      y_vector = null;
    ...
    /** Sets the value of the 'geometry_type' field */
    public avro.java.gaia.shape_intersection_request.Builder setGeometryType(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.shape_intersection_request.Builder clearGeometryType() {
      geometry_type = null;
    ...
    /** Sets the value of the 'wkt_string' field */
    public avro.java.gaia.shape_intersection_request.Builder setWktString(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.shape_intersection_request.Builder clearWktString() {
      wkt_string = null;
    ...
    /** Sets the value of the 'user_auth_string' field */
    public avro.java.gaia.shape_intersection_request.Builder setUserAuthString(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.shape_intersection_request.Builder clearUserAuthString() {
