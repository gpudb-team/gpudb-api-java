...
public class cluster_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static avro.java.gaia.cluster_response.Builder newBuilder() {
    return new avro.java.gaia.cluster_response.Builder();
  }
  
  /** Creates a new cluster_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.cluster_response.Builder newBuilder(avro.java.gaia.cluster_response.Builder other) {
    return new avro.java.gaia.cluster_response.Builder(other);
  }
  
  /** Creates a new cluster_response RecordBuilder by copying an existing cluster_response instance */
  public static avro.java.gaia.cluster_response.Builder newBuilder(avro.java.gaia.cluster_response other) {
    return new avro.java.gaia.cluster_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<cluster_response>
    ...
    private Builder() {
      super(avro.java.gaia.cluster_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.cluster_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing cluster_response instance */
    private Builder(avro.java.gaia.cluster_response other) {
            super(avro.java.gaia.cluster_response.SCHEMA$);
    ...
    /** Sets the value of the 'attributes' field */
    public avro.java.gaia.cluster_response.Builder setAttributes(java.util.List<java.lang.CharSequence> value) {
    ...
    public avro.java.gaia.cluster_response.Builder clearAttributes() {
      attributes = null;
    ...
    /** Sets the value of the 'count_map' field */
    public avro.java.gaia.cluster_response.Builder setCountMap(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public avro.java.gaia.cluster_response.Builder clearCountMap() {
      count_map = null;
    ...
    /** Sets the value of the 'first_pass' field */
    public avro.java.gaia.cluster_response.Builder setFirstPass(boolean value) {
    ...
    public avro.java.gaia.cluster_response.Builder clearFirstPass() {
    ...
    /** Sets the value of the 'list' field */
    public avro.java.gaia.cluster_response.Builder setList(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gaia.cluster_response.Builder clearList() {
      list = null;
    ...
    /** Sets the value of the 'set_id' field */
    public avro.java.gaia.cluster_response.Builder setSetId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.cluster_response.Builder clearSetId() {
      set_id = null;
