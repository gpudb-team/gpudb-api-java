...
public class get_type_info_request extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"get_type_info_request\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"type_id\",\"type\":\"string\"},{\"name\":\"label\",\"type\":\"string\"},{\"name\":\"semantic_type\",\"type\":\"string\"}]}");
  ...
  public static avro.java.gaia.get_type_info_request.Builder newBuilder() {
    return new avro.java.gaia.get_type_info_request.Builder();
  }
  
  /** Creates a new get_type_info_request RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.get_type_info_request.Builder newBuilder(avro.java.gaia.get_type_info_request.Builder other) {
    return new avro.java.gaia.get_type_info_request.Builder(other);
  }
  
  /** Creates a new get_type_info_request RecordBuilder by copying an existing get_type_info_request instance */
  public static avro.java.gaia.get_type_info_request.Builder newBuilder(avro.java.gaia.get_type_info_request other) {
    return new avro.java.gaia.get_type_info_request.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<get_type_info_request>
    ...
    private Builder() {
      super(avro.java.gaia.get_type_info_request.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.get_type_info_request.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing get_type_info_request instance */
    private Builder(avro.java.gaia.get_type_info_request other) {
            super(avro.java.gaia.get_type_info_request.SCHEMA$);
    ...
    /** Sets the value of the 'type_id' field */
    public avro.java.gaia.get_type_info_request.Builder setTypeId(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.get_type_info_request.Builder clearTypeId() {
      type_id = null;
    ...
    /** Sets the value of the 'label' field */
    public avro.java.gaia.get_type_info_request.Builder setLabel(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.get_type_info_request.Builder clearLabel() {
      label = null;
    ...
    /** Sets the value of the 'semantic_type' field */
    public avro.java.gaia.get_type_info_request.Builder setSemanticType(java.lang.CharSequence value) {
    ...
    public avro.java.gaia.get_type_info_request.Builder clearSemanticType() {
      semantic_type = null;
