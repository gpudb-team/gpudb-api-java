...
public class convex_hull_response extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"convex_hull_response\",\"namespace\":\"avro.java.gaia\",\"fields\":[{\"name\":\"x_vector\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"y_vector\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"count\",\"type\":\"int\"},{\"name\":\"is_valid\",\"type\":\"boolean\"}]}");
  ...
  public static avro.java.gaia.convex_hull_response.Builder newBuilder() {
    return new avro.java.gaia.convex_hull_response.Builder();
  }
  
  /** Creates a new convex_hull_response RecordBuilder by copying an existing Builder */
  public static avro.java.gaia.convex_hull_response.Builder newBuilder(avro.java.gaia.convex_hull_response.Builder other) {
    return new avro.java.gaia.convex_hull_response.Builder(other);
  }
  
  /** Creates a new convex_hull_response RecordBuilder by copying an existing convex_hull_response instance */
  public static avro.java.gaia.convex_hull_response.Builder newBuilder(avro.java.gaia.convex_hull_response other) {
    return new avro.java.gaia.convex_hull_response.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<convex_hull_response>
    ...
    private Builder() {
      super(avro.java.gaia.convex_hull_response.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(avro.java.gaia.convex_hull_response.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing convex_hull_response instance */
    private Builder(avro.java.gaia.convex_hull_response other) {
            super(avro.java.gaia.convex_hull_response.SCHEMA$);
    ...
    /** Sets the value of the 'x_vector' field */
    public avro.java.gaia.convex_hull_response.Builder setXVector(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gaia.convex_hull_response.Builder clearXVector() {
      x_vector = null;
    ...
    /** Sets the value of the 'y_vector' field */
    public avro.java.gaia.convex_hull_response.Builder setYVector(java.util.List<java.lang.Double> value) {
    ...
    public avro.java.gaia.convex_hull_response.Builder clearYVector() {
      y_vector = null;
    ...
    /** Sets the value of the 'count' field */
    public avro.java.gaia.convex_hull_response.Builder setCount(int value) {
    ...
    public avro.java.gaia.convex_hull_response.Builder clearCount() {
    ...
    /** Sets the value of the 'is_valid' field */
    public avro.java.gaia.convex_hull_response.Builder setIsValid(boolean value) {
    ...
    public avro.java.gaia.convex_hull_response.Builder clearIsValid() {
