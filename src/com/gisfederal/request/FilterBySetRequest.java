...
public class FilterBySetRequest extends Request {
	...
	public FilterBySetRequest(Gaia gaia, String file, SetId in_set, SetId result_set_id, String attribute, SetId sourceId, String src_attribute) {
		this.gaia = gaia;
		this.file = file;		
		this.log = Logger.getLogger(FilterBySetRequest.class);
		
		this.log.debug("gaia:"+gaia.toString()+" in_set:"+in_set.get_id());
		filter_by_set_request request = new filter_by_set_request(in_set.get_id(), result_set_id.get_id(), attribute, sourceId.get_id(), src_attribute, this.gaia.getUserAuth()); 
